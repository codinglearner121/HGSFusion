...
class VoxelBackBone8x(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        """
        voxel_features, voxel_coords = batch_dict['radar_voxel_features'], batch_dict['voxel_coords']
        ...
        x = self.conv_input(input_sp_tensor) # [32, 320, 320] -> [32, 320, 320]

        x_conv1 = self.conv1(x) # [32, 320, 320]
        x_conv2 = self.conv2(x_conv1) # [16, 160, 160]
        x_conv3 = self.conv3(x_conv2) # [8, 80, 80]
        x_conv4 = self.conv4(x_conv3) # [3, 40, 40]

        # for detection head
        # [200, 176, 5] -> [200, 176, 2]
        out = self.conv_out(x_conv4)  # [1, 40, 40]
